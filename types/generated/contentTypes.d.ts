...
export interface ApiContactMessageContactMessage
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    MessageContent: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGalleryItemGalleryItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    StripeProductID: Schema.Attribute.Text;
...
export interface ApiGalleryTextGalleryText extends Struct.CollectionTypeSchema {
  collectionName: 'gallery_texts';
  info: {
    displayName: 'Gallery Text';
    pluralName: 'gallery-texts';
    singularName: 'gallery-text';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiStoreTextStoreText extends Struct.CollectionTypeSchema {
  collectionName: 'store_texts';
  info: {
    displayName: 'Store Text';
    pluralName: 'store-texts';
    singularName: 'store-text';
  };
  options: {
    draftAndPublish: true;
  };
